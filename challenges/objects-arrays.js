...
console.log(dinosaurs.velocipaptor.diet);
...
dinosaur.roar = 'RAWERSRARARWERSARARARRRR!'
...
zooAnimals.forEach(function(zooAnimal){
  console.log(`Name: ${zooAnimal.animal_name}, Scientific: ${zooAnimal.scientific_name}.`)})
